...
import { Family_Food } from '../screens/Item_imges_js/Hotel-Veg/Family_Food';
...
export default class OrderFamily_Special extends Component {
  constructor(props) {
    super(props);
    this.state = {
        fontsLoaded: false,
        ...
        <View style={styles.container}>
          <View style={styles.appTitle}>
            <View style={styles.appTitleTextContainer}>
              <Text style={styles.appTitleText}>Family Food</Text>
            </View>
          </View>
          <ScrollView>
          <View style={styles.orderContainer}>
            <View style={{ flex: 1, height: RFValue(100) }}>
              <Carousel data={Family_Food} />
            </View>
            <View>
