...
import { Tandoori_roti } from '../screens/Item_imges_js/Hotel-Veg/Tandoori_roti';
...
export default class OrderTandoori_roti extends Component {
   constructor(props) {
    super(props);
    this.state = {
        fontsLoaded: false,
        ...
        <View style={styles.container}>
          <View style={styles.appTitle}>
            <View style={styles.appTitleTextContainer}>
              <Text style={styles.appTitleText}>Tandoori Roti</Text>
            </View>
          </View><ScrollView>
          <View style={styles.orderContainer}>
            <View style={{ flex: 1, height: RFValue(100) }}>
              <Carousel data={Tandoori_roti} />
            </View>
            <View>
