...
import { Paneer } from '../screens/Item_imges_js/Hotel-Veg/Paneer';
...
export default class OrderPaneer extends Component {
 constructor(props) {
    super(props);
    this.state = {
        fontsLoaded: false,
        ...
        <View style={styles.container}>
          <View style={styles.appTitle}>
            <View style={styles.appTitleTextContainer}>
              <Text style={styles.appTitleText}>Paneer</Text>
            </View>
          </View><ScrollView>
          <View style={styles.orderContainer}>
            <View style={{ flex: 1, height: RFValue(100) }}>
              <Carousel data={Paneer} />
            </View>
            <View>
