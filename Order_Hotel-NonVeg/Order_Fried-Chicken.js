...
import { Fried_Chicken } from '../screens/Item_imges_js/Hotel-NonVeg/Fried_Chicken';
...
export default class OrderFried_Chicken extends Component {
 constructor(props) {
    super(props);
    this.state = {
        fontsLoaded: false,
        ...
        <View style={styles.container}>
          <View style={styles.appTitle}>
            <View style={styles.appTitleTextContainer}>
              <Text style={styles.appTitleText}>Fried Chicken</Text>
            </View>
          </View>
          <ScrollView>
          <View style={styles.orderContainer}>
            <View style={{ flex: 1, height: RFValue(100) }}>
              <Carousel data={Fried_Chicken} />
            </View>
            <View>
