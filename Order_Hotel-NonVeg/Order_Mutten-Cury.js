...
import { Mutten_Cury } from '../screens/Item_imges_js/Hotel-NonVeg/Mutten_Cury';
...
export default class OrderMutten_Cury extends Component {
  constructor(props) {
    super(props);
    this.state = {
        fontsLoaded: false,
        ...
        <View style={styles.container}>
          <View style={styles.appTitle}>
            <View style={styles.appTitleTextContainer}>
              <Text style={styles.appTitleText}>Mutten Cury</Text>
            </View>
          </View>
          <ScrollView>
          <View style={styles.orderContainer}>
            <View style={{ flex: 1, height: RFValue(100) }}>
              <Carousel data={Mutten_Cury} />
            </View>
            <View>
