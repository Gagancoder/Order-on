...
export default class Hotel_Veg extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fontsLoaded: false,
      ...
      return (
        <SafeAreaProvider>
          <View style={styles.container}>
            ...
            <View>
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate('Family_Fun')}>
                <FlatList
                  keyExtractor={this.keyExtractor}
            ...
            <View>
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate('Paneer')}>
                <FlatList
                  keyExtractor={this.keyExtractor}
                  data={Paneer_Details}
                  renderItem={this.renderItem}
            ...
            <View>
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate('Tandoori_Roti')}>
                <FlatList
                  keyExtractor={this.keyExtractor}
            ...
            <View>
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate('Mix_Veg')}>
                <FlatList
                  keyExtractor={this.keyExtractor}
