...
import { Bell_Pepper } from '../screens/Item_imges_js/Vegetable/Bell_Pepper';
...
export default class OrderBell_Pepper extends Component {
  constructor(props) {
    super(props);
    this.state = {
        fontsLoaded: false,
        ...
        <View style={styles.container}>
          <View style={styles.appTitle}>
            <View style={styles.appTitleTextContainer}>
              <Text style={styles.appTitleText}>Bell_Pepper</Text>
            </View>
          </View>
          <ScrollView>
          <View style={styles.orderContainer}>
            <View style={{ flex: 1, height: RFValue(100) }}>
              <Carousel data={Bell_Pepper} />
            </View>
            <View>
