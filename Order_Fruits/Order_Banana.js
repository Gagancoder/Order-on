...
import { Banana } from '../screens/Item_imges_js/Fruits/Banana';
...
export default class Order_Banana extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fontsLoaded: false,
        ...
        <View style={styles.container}>
          <View style={styles.appTitle}>
            <View style={styles.appTitleTextContainer}>
              <Text style={styles.appTitleText}>Banana</Text>
            </View>
          </View>
          <View style={styles.orderContainer}>
            <View style={{ flex: 1, height: RFValue(100) }}>
              <Carousel data={Banana} />
            </View>
            <View>
